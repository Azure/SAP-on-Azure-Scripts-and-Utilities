...
read sdp <<< $(sudo lsscsi -u -i 3 | grep 3:0:0:13 | awk '{print $4}')
read sdq <<< $(sudo lsscsi -u -i 3 | grep 3:0:0:14 | awk '{print $4}')
read sdr <<< $(sudo lsscsi -u -i 3 | grep 3:0:0:15 | awk '{print $4}')
