...
# Update fstab
echo "/dev/sdi1 /hana/shared  ext4  defaults,barrier=0,nofail  0  2" | sudo tee -a /etc/fstab
...
sudo mkdir /usr/sap
# Update fstab
echo "/dev/sdj1 /usr/sap  ext4  defaults,barrier=0,nofail  0  2" | sudo tee -a /etc/fstab
