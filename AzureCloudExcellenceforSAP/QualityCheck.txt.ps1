...
"@ -replace 'mc:Ignorable="d"','' -replace "x:N",'N' -replace '^<Win.*', '<Window' #-replace wird benÃ¶tigt, wenn XAML aus Visual Studio kopiert wird.
    ...
    Write-Host "Windows.Markup.XamlReader konnte nicht geladen werden. MÃ¶gliche Ursache: ungÃ¼ltige Syntax oder fehlendes .net"
    }
